...
class Abstraction:
    ...
    def operation(self) -> str:
        return (f"Abstração: operação básica com:\n"
...
class ExtendedAbstraction(Abstraction):
    ...
    def operation(self) -> str:
        return (f"ExtendedAbstraction: operação estendida comh:\n"
                f"{self.implementation.operation_implementation()}")
...
if __name__ == "__main__":
    """
    O código do cliente deve ser capaz de trabalhar com qualquer abstração pré-configurada-
     combinação de implementação.
    """
